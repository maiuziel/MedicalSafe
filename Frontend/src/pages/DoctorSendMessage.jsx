...
export default function DoctorSendMessage() {
  ...
  const fetchSecretaries = async () => {
    try {
      const res = await fetch("https://medicalsafe.duckdns.org/api/messages/secretaries", {
  ...
  const fetchHistory = async () => {
    const res = await fetch("https://medicalsafe.duckdns.org/api/messages/sent", {
      headers: { Authorization: `Bearer ${token}` },
    });
  ...
  const handleSend = async () => {
    ...
    const res = await fetch("https://medicalsafe.duckdns.org/api/messages/doctor-to-secretary", {
      method: "POST",
      headers: {
