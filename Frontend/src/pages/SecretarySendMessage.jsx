...
export default function SecretarySendMessage() {
  ...
  const fetchHistory = async () => {
    const res = await fetch("https://medicalsafe-backend.onrender.com/api/secretary/messages/sent", {
      headers: { Authorization: `Bearer ${token}` },
    });
  ...
  const handleSend = async () => {
    ...
    const res = await fetch("https://medicalsafe-backend.onrender.com/api/secretary/messages", {
      method: "POST",
      headers: {
